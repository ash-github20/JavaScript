function validate() {
	...
	else if ((document.myForm.Name.value.length < 5) || (document.myForm.Name.value.length > 50)) {
	...
	else if ((document.myForm.passwd.value.length < 15) || (document.myForm.Name.value.length > 50)) {
		alert("Password should be atleast of 15 letters!");
		document.myForm.Name.focus();
		return false;
	}
